...
namespace hrd_holding.Controllers
{
    public class ReqRecruitmentController : Controller
    {
        ...
        public dynamic GetRequestLookUp(int pCompanyId, int pBranchId)
        {
            //LOG.Debug(DateTime.Now + " ---- PageNum : " + pagenum + " PageSize : " + pagesize);
            ...
            // Get Data
            var vObjRes = _reqService.GetRequestList(pCompanyId, pBranchId, 0, pagenum, pagesize, where, orderby);
            var vList = vObjRes.objResult as IEnumerable<hrdReqRecruitmentModel>;
