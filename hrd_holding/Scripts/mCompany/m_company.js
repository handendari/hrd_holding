    ...
    $("#tblCountryLookUp").jqxGrid(
      {
          ...
          columns: [
              ...
              { text: 'Int Code', dataField: 'int_coountry', width: 80, cellsalign: 'center', align: 'center' },
              { text: 'Name', dataField: 'country_name', width: 200 }
          ]
      });
}
                ...
                case 0:
                    ...
                    tool.on("click", function () {
                        ...
                        if (rowindex >= 0) {
                            ...
                            $("#txtCompIntCountryName").val(rd.country_name);
